  ...
  <div class="container">
   <div class="row">
    ...
    <div class="col-md-4 well" style="margin-top:100px;">
      ...
      <h4 style="font-family: 'Oswald', sans-serif;">SPM GROUP <sup>(Supervisor Login)</sup></h4>
      <!-- -->
      <form class="form-horizontal" action="<?php echo base_url();?>index.php/Index/superlogin" method="post" enctype="multipart/form-data">
