  ...
  <section id="mainbody">
    <div class="container">
     <div class="row">
      ...
      <h3 class="alert alert-info">Transfer Worker</h3>
      <div class="col-md-12 well" style="padding-bottom:25px;">
        ...
        ?>
        <?php echo form_open('Index/transfer_worker',$form_attribute); ?>
    ...
    <?php if (isset($listing_data)): ?>
      <div class="row">
        <h3 class="alert alert-info"> Worker List Of <?php echo $plant_name ?></h3>
        <form method="post" action="<?php echo base_url() ?>Add/transfer_worker">
          <label for="ddlPlant">Select Plant To Transfer</label>
           <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-industry" aria-hidden="true"></i></span>
          <select name="ddlPlant" required id="ddlPlant" class="form-control">
            <option value="" hidden>Select Plant</option>
      ...
      <p align="center">
        <button type="submit" value="transfrt" name="btnTransfer" class="btn btn-info btn-lg"> <i class="fa fa-exchange" aria-hidden="true"></i> Transfer Worker</button>
      </p>
      </form>
    </div>
  <?php endif; ?>
